...
* multi_synth.py: polyphonic additive synthesizer with eight-note polyphony by default
* multi_wave.py: polyphonic wavetable synthesizer which uses a piano wavetable from Surge XT by default
